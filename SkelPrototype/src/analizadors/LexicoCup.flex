...
(dex) {return new Symbol(sym.Decimal, yychar, yyline, yytext());}
...
(grant) {return new Symbol(sym.Asigna, yychar, yyline, yytext());}
...
(vdd|falso) {return new Symbol(sym.TrueFalse, yychar, yyline, yytext());}
