...
public class BCProductos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Baja/Consultas de productos.");
    ...
    public void metodoBaja() {
        try {
            ...
            CallableStatement insert = (CallableStatement) con.prepareCall("{call Baja_Productos(?)}");
            ...
            JOptionPane.showMessageDialog(null, "Error, no se pudo dar de baja al Producto " + e);
    ...
    public void metodoConsulta() {
        ...
        if (IDProducto.getText().equals("")) {
          ...
          sql = "select * from Productos where ID_Producto =" + IDProducto.getText();   
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BCProductos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BCProductos().setVisible(true);
            }
        });
    }
